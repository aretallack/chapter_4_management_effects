...
=======
>>>>>>> 87e8d9f98256a9a72cff7c4b335eb7c66aedc204
```
...
fences <- read_sf("E:/data/Basedata/Pastoral/Statewide/ADMIN_PastoralStations_GDA2020.shp")
sf::write_sf(fences, "./data/vector/pastoral_stations.gpkg")
...
```{r eval = FALSE}
names(df) <- c("x", "y", "date", "cell", "pv", "npv", "bare", "p_agcd", "p_agcd_3", "p_agcd_12", "station", "paddock", "ibra_region", "ibra_subregion", "land_system", "land_system_id", "nvis_subgroup", "nvis_group", "study_zone", "fence_buffer", "dog_fence", "water")
```
