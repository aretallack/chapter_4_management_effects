...
## Assess NVIS frequency in Bon Bon study area

```{r eval = FALSE}
# tmp <- as.data.frame(bonbon)
...
```{r}
bonbon <- bonbon %>% 
  filter(nvis_group %in% c("Chenopod Shrublands, Samphire Shrublands and Forblands", "Acacia Open Woodlands"))
```
