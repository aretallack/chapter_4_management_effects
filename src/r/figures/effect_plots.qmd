...
pv_eff <- plot_effects(effects, "pv05_eff", labelx = ymd("2014-09", truncated = 1),labely = 1.05, legend_position = c(0.80, 0.11)) +
...
npv_eff <- plot_effects(effects, "npv05_eff", labelx = ymd("2014-09", truncated = 1),labely = 1.75, legend_position = c(0.80, 0.11)) +
...
bare_eff <- plot_effects(effects, "bare95_eff", labelx = ymd("2014-09", truncated = 1),labely = 0.2, legend_position = c(0.18, 0.11)) +
