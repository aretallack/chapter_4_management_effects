...
pv_eff <- plot_effects(effects, "pv05_eff", labelx = ymd("2014-09", truncated = 1),labely = 1.1, legend_position = c(0.80, 0.11)) +
...
npv_eff <- plot_effects(effects, "npv05_eff", labelx = ymd("2014-09", truncated = 1),labely = 1.9, legend_position = c(0.80, 0.11)) +
